...
public final class ClientReceiveMessageEvents {
	 ...
	 * {@link net.minecraft.class_746#method_7353(class_2561, boolean) ClientPlayerEntity.sendMessage(message, overlay)}.
	 */
	 ...
	 * and manually add the new message to the chat hud using {@link class_338#method_1812(class_2561)}
	 */
	...
	public interface AllowChat {
		 ...
		 */
		boolean allowReceiveChatMessage(class_2561 message, @Nullable class_7471 signedMessage, @Nullable GameProfile sender, class_2556.class_7602 params, Instant receptionTimestamp);
	}
	...
	public interface AllowGame {
		 ...
		 * @return {@code true} if the message should be displayed, otherwise {@code false}
		 */
		boolean allowReceiveGameMessage(class_2561 message, boolean overlay);
	}
	...
	public interface ModifyGame {
		 ...
		 */
		class_2561 modifyReceivedGameMessage(class_2561 message, boolean overlay);
	}
	...
	public interface Chat {
		 ...
		 * @param receptionTimestamp the timestamp when the message was received
		 */
		void onReceiveChatMessage(class_2561 message, @Nullable class_7471 signedMessage, @Nullable GameProfile sender, class_2556.class_7602 params, Instant receptionTimestamp);
	}
	...
	public interface Game {
		 ...
		 * @param overlay whether the message will be displayed in the action bar
		 */
		void onReceiveGameMessage(class_2561 message, boolean overlay);
	}
	...
	public interface ChatCanceled {
		 ...
		 * @param receptionTimestamp the timestamp when the message was received
		 */
		void onReceiveChatMessageCanceled(class_2561 message, @Nullable class_7471 signedMessage, @Nullable GameProfile sender, class_2556.class_7602 params, Instant receptionTimestamp);
	}
	...
	public interface GameCanceled {
		 ...
		 */
		void onReceiveGameMessageCanceled(class_2561 message, boolean overlay);
	}
}
